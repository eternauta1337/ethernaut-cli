...
## Things that can't be done atm

1. Change the scope of a task
2. Allow a task with required args to be ran in interactive mode and collect the args after parsing
3. Execute an action when landing on a scope (like in commanderjs nested commands)
